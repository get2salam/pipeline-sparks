  ...
  "tagline": "Track lightweight opportunities before they either compound or cool off.",
  "domainLabel": "opportunities",
  "itemLabel": "opportunity",
  "emptyTitle": "No opportunities yet",
  "emptyBody": "Add leads, referrals, or partnership ideas worth watching.",
  "seedTitle": "Opportunity sparks",
  "seedSubtitle": "A tiny pipeline board for warming up real opportunities.",
  "categories": [
    "Lead",
    "Referral",
    "Partner",
  ...
  "items": [
    {
      ...
      "score": 8,
      "effort": 2,
      "note": "Use one specific improvement as the re-entry reason."
    },
    {
      "title": "University AI society talk",
      "category": "Partner",
      "state": "Warm",
      "score": 7,
      "effort": 3,
      "note": "Could lead to visibility and unexpected relationships."
    },
    {
      "title": "Referral ask from happy client",
      "category": "Referral",
      "state": "New",
      "score": 9,
      "effort": 1,
      "note": "Easier to do when the recent win is still fresh."
    }
  ]
};
